...
1. go to `phase2` folder in [phase2-bn254](https://github.com/esketit-cash/phase2-bn254) and run the following command:
...
1. `git clone https://github.com/esketit-cash/phase2-bn254 && cd phase2-bn254`
1. `cd powersoftau`
...
1. `wget https://github.com/esketit-cash/tornado-core/releases/download/v2.0/withdraw.json -O circuit.json`
...
Note. 
1. Your also need to use [special](https://github.com/esketit-cash/websnark.git#4c0af6a8b65aabea3c09f377f63c44e7a58afa6d) version of websnark lib on the UI.
...
1. Download [withdraw.json](https://github.com/esketit-cash/tornado-core/releases/download/v2.0/withdraw.json) for required circuit to `./phase2` folder
1. `cd ../phase2`
